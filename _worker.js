...
function getVLESSConfig(userID, hostName) {
	...
	return 
		...
		const วเลสMain = ${userID}\u0040${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
		const วเลสSec = ${userID}\u0040${hostName}:443?encryption=none&security=tls&sni=${hostName}&fp=randomized&type=ws&host=${hostName}&path=%2F%3Fed%3D2048#${hostName}`;
		return 
---------------------------------------------------------------
${วเลสMain}
